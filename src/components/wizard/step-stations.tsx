    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        {draft.stations.map((station, idx) => (
          <div
            key={station.id}
            className="border-border bg-background/40 flex items-center gap-2 rounded-md border p-2"
          >
            ...
            <div className="flex items-center gap-1.5">
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  if (Number.isFinite(n) && n > 0) updateStation(idx, { cycleMs: n });
                }}
            ...
            {idx < draft.stations.length - 1 ? (
              <ArrowRight className="text-muted-foreground/40 h-3.5 w-3.5 shrink-0" aria-hidden />
            ) : null}
          </div>
        ))}
      </div>
