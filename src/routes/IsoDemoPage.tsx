  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] flex-col gap-3 p-6">
      <header className="flex items-baseline justify-between gap-3">
        <div>
          <h1 className="font-heading text-2xl font-bold tracking-tight">Iso demo</h1>
          <p className="text-muted-foreground text-sm">
            Sandbox for the PixiJS isometric renderer (VROL-187/191/852). Drag to pan, scroll to
            zoom.
          </p>
        </div>
